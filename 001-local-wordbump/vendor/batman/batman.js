...
(function () {
  ...
  Batman.DOM.StyleBinding = (function (_super) {
    ...
    StyleBinding.prototype.setStyle = function (key, value) {
      ...
      if ((_ref = (_base = this.oldStyles)[key]) == null) {
        _base[key] = this.node.style[key];
      }
      ...
      switch (valueType) {
        case 'Array':
          return ((function () {
            ...
            results = [];
            if (value.length === 0) {
              results.push(queryFromParams(null, "" + prefix + "[]"));
            }
            for (_i = 0, _len = value.length; _i < _len; _i++) {
              v = value[_i];
              results.push(queryFromParams(v, "" + prefix + "[]"));
              void 0;
            }
            return results;
          })()).join("&");
    ...
    options = {
      ...
      success: function (response) {
        _this.mixin({
          xhr: xhr,
          response: response,
          status: (typeof xhr !== "undefined" && xhr !== null ? xhr.status : void 0) || 200,
